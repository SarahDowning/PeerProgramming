...
public class Questions {
	...
	public String multiChar(String input) {
		int l = input.length();
		String myString = "";
		for (int stringLength = 0; stringLength < l; stringLength++) {
			myString += input.substring(stringLength, stringLength + 1)
					+ input.substring(stringLength, stringLength + 1) + input.substring(stringLength, stringLength + 1);
...
//		int a = sandwich.indexOf("bread");
//		int b = sandwich.indexOf("bread");
//		return b - a > 4 ? sandwich.substring(a + 5, b) : "";
//	}

//		if (sandwich.length() <= 10)
//			return "";
//		return sandwich.substring(sandwich.indexOf("bread") + 5, 
//				sandwich.lastIndexOf("bread"));

//		int first = sandwich.indexOf("bread");
//		int last = sandwich.indexOf("bread");
//		if (first == last)
//			return "";
//		return sandwich.substring(first + 5, last);
//	}
	 ...
	 */
	public int amISearch(String sentence, String am) {
